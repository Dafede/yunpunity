...
{
internal class StandardOutlinedShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		// customized shader
		public static GUIContent outlineColorText = new GUIContent("Outline Color", "Color of the outline");
	...
	MaterialProperty drawOutline = null;
	...
	{	
		...
		drawOutline = FindProperty ("_DrawOutline", props);
		//
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			DoOutlineArea (material); // custom shader
	...
	void DoOutlineArea(Material material)
	{
		...
		m_MaterialEditor.FloatProperty (drawOutline, "TEST");
	}
